(() => {
  ...
  const levels = [
    ...
    },
    {
      ...
      objective: 'Thirteen lenses. A deep circuit with long silent stretches and traps.',
      grid: 12,
      ...
      mirrors: [
        ...
        { col: 10, row: 7, orientation: 0, solution: 1, role: 'true' },
        ...
        { col: 6, row: 11, orientation: 0, solution: 1, role: 'true' },
        { col: 11, row: 11, orientation: 1, solution: 0, role: 'true' },
        { col: 6, row: 5, orientation: 0, solution: 1, role: 'decoy' },
        { col: 4, row: 6, orientation: 1, solution: 1, role: 'decoy' },
        { col: 3, row: 2, orientation: 1, solution: 0, role: 'decoy' },
        { col: 8, row: 8, orientation: 0, solution: 1, role: 'decoy' },
        { col: 3, row: 7, orientation: 1, solution: 1, role: 'decoy' },
        { col: 11, row: 3, orientation: 1, solution: 0, role: 'decoy' },
    ...
    },
    {
      id: 21,
      title: 'Crystal Fold',
      objective: 'Fifteen true lenses. Fold the beam through a long crystal route.',
      grid: 12,
      source: { col: 0, row: 11, dir: 'right' },
      target: { col: 1, row: 0 },
      mirrors: [
        { col: 5, row: 11, orientation: 1, solution: 0, role: 'true' },
        { col: 5, row: 7, orientation: 1, solution: 0, role: 'true' },
        { col: 10, row: 7, orientation: 0, solution: 1, role: 'true' },
        { col: 10, row: 10, orientation: 1, solution: 0, role: 'true' },
        { col: 2, row: 10, orientation: 0, solution: 1, role: 'true' },
        { col: 2, row: 4, orientation: 1, solution: 0, role: 'true' },
        ...
        { col: 8, row: 1, orientation: 0, solution: 1, role: 'true' },
        { col: 3, row: 1, orientation: 1, solution: 0, role: 'true' },
        { col: 3, row: 6, orientation: 0, solution: 1, role: 'true' },
        { col: 11, row: 6, orientation: 1, solution: 0, role: 'true' },
        { col: 11, row: 2, orientation: 0, solution: 1, role: 'true' },
        { col: 6, row: 2, orientation: 1, solution: 0, role: 'true' },
        { col: 6, row: 9, orientation: 1, solution: 0, role: 'true' },
        { col: 1, row: 9, orientation: 0, solution: 1, role: 'true' },
        { col: 7, row: 3, orientation: 1, solution: 1, role: 'decoy' },
        { col: 0, row: 10, orientation: 1, solution: 1, role: 'decoy' },
        { col: 7, row: 0, orientation: 0, solution: 0, role: 'decoy' },
        { col: 0, row: 7, orientation: 0, solution: 0, role: 'decoy' },
        { col: 11, row: 1, orientation: 1, solution: 1, role: 'decoy' },
        { col: 4, row: 8, orientation: 1, solution: 1, role: 'decoy' },
        { col: 10, row: 11, orientation: 0, solution: 0, role: 'decoy' },
        { col: 0, row: 4, orientation: 1, solution: 1, role: 'decoy' },
        { col: 8, row: 9, orientation: 0, solution: 0, role: 'decoy' }
      ]
    },
    {
      id: 22,
      title: 'Moon Lattice',
      objective: 'Sixteen true lenses. Trace a lattice path across the full board.',
      grid: 13,
      ...
      mirrors: [
        ...
        { col: 4, row: 11, orientation: 0, solution: 1, role: 'true' },
        { col: 11, row: 11, orientation: 1, solution: 0, role: 'true' },
        { col: 11, row: 5, orientation: 0, solution: 1, role: 'true' },
        { col: 7, row: 5, orientation: 0, solution: 1, role: 'true' },
        { col: 7, row: 1, orientation: 1, solution: 0, role: 'true' },
        { col: 12, row: 1, orientation: 0, solution: 1, role: 'true' },
        { col: 12, row: 6, orientation: 1, solution: 0, role: 'true' },
        { col: 2, row: 6, orientation: 0, solution: 1, role: 'true' },
        { col: 2, row: 2, orientation: 1, solution: 0, role: 'true' },
        { col: 6, row: 2, orientation: 0, solution: 1, role: 'true' },
        { col: 6, row: 9, orientation: 1, solution: 0, role: 'true' },
        { col: 0, row: 9, orientation: 0, solution: 1, role: 'true' },
        { col: 0, row: 3, orientation: 1, solution: 0, role: 'true' },
        { col: 6, row: 0, orientation: 0, solution: 0, role: 'decoy' },
        { col: 7, row: 12, orientation: 1, solution: 1, role: 'decoy' },
        { col: 5, row: 10, orientation: 1, solution: 1, role: 'decoy' },
        { col: 3, row: 8, orientation: 1, solution: 1, role: 'decoy' },
        { col: 1, row: 6, orientation: 1, solution: 1, role: 'decoy' },
        { col: 12, row: 0, orientation: 0, solution: 0, role: 'decoy' },
        { col: 7, row: 9, orientation: 0, solution: 0, role: 'decoy' },
        { col: 5, row: 7, orientation: 0, solution: 0, role: 'decoy' },
        { col: 3, row: 5, orientation: 0, solution: 0, role: 'decoy' },
        { col: 5, row: 4, orientation: 1, solution: 1, role: 'decoy' }
      ]
    },
    {
      id: 23,
    ...
    },
    {
      id: 24,
      title: 'Aurora Weave',
      objective: 'Eighteen true lenses. Weave across the board in long calm bands.',
      grid: 13,
      ...
      mirrors: [
        ...
        { col: 10, row: 12, orientation: 1, solution: 0, role: 'true' },
        ...
        { col: 11, row: 6, orientation: 1, solution: 0, role: 'true' },
        { col: 1, row: 6, orientation: 0, solution: 1, role: 'true' },
        { col: 1, row: 2, orientation: 1, solution: 0, role: 'true' },
        { col: 4, row: 2, orientation: 0, solution: 1, role: 'true' },
        { col: 4, row: 10, orientation: 0, solution: 1, role: 'true' },
        { col: 9, row: 10, orientation: 1, solution: 0, role: 'true' },
        { col: 9, row: 5, orientation: 0, solution: 1, role: 'true' },
        { col: 5, row: 5, orientation: 1, solution: 0, role: 'true' },
        { col: 5, row: 7, orientation: 0, solution: 1, role: 'true' },
        { col: 11, row: 9, orientation: 0, solution: 0, role: 'decoy' },
        { col: 0, row: 12, orientation: 0, solution: 0, role: 'decoy' },
        { col: 3, row: 1, orientation: 0, solution: 0, role: 'decoy' },
        { col: 9, row: 4, orientation: 1, solution: 1, role: 'decoy' },
        { col: 7, row: 2, orientation: 1, solution: 1, role: 'decoy' },
        { col: 2, row: 11, orientation: 1, solution: 1, role: 'decoy' },
        { col: 5, row: 0, orientation: 1, solution: 1, role: 'decoy' },
        { col: 0, row: 9, orientation: 1, solution: 1, role: 'decoy' },
        { col: 2, row: 8, orientation: 0, solution: 0, role: 'decoy' },
        { col: 0, row: 6, orientation: 0, solution: 0, role: 'decoy' },
        { col: 8, row: 11, orientation: 1, solution: 1, role: 'decoy' },
        { col: 6, row: 9, orientation: 1, solution: 1, role: 'decoy' }
      ]
    },
    {
      id: 25,
      title: 'Glass Constellation',
      objective: 'Nineteen true lenses. A full constellation route with heavy decoys.',
      grid: 13,
      source: { col: 0, row: 0, dir: 'right' },
      target: { col: 9, row: 3 },
      mirrors: [
        ...
        { col: 11, row: 2, orientation: 0, solution: 1, role: 'true' },
        { col: 6, row: 2, orientation: 1, solution: 0, role: 'true' },
        { col: 6, row: 6, orientation: 1, solution: 0, role: 'true' },
        { col: 1, row: 6, orientation: 0, solution: 1, role: 'true' },
        { col: 1, row: 1, orientation: 1, solution: 0, role: 'true' },
        { col: 4, row: 1, orientation: 0, solution: 1, role: 'true' },
        { col: 4, row: 8, orientation: 0, solution: 1, role: 'true' },
        { col: 9, row: 8, orientation: 1, solution: 0, role: 'true' },
        { col: 1, row: 11, orientation: 1, solution: 1, role: 'decoy' },
        { col: 10, row: 3, orientation: 0, solution: 0, role: 'decoy' },
        { col: 5, row: 12, orientation: 0, solution: 0, role: 'decoy' },
        { col: 8, row: 1, orientation: 0, solution: 0, role: 'decoy' },
        { col: 3, row: 10, orientation: 0, solution: 0, role: 'decoy' },
        { col: 1, row: 8, orientation: 0, solution: 0, role: 'decoy' },
        { col: 3, row: 7, orientation: 1, solution: 1, role: 'decoy' },
        { col: 9, row: 10, orientation: 0, solution: 0, role: 'decoy' },
        { col: 7, row: 5, orientation: 1, solution: 1, role: 'decoy' },
        { col: 5, row: 3, orientation: 1, solution: 1, role: 'decoy' },
        { col: 0, row: 12, orientation: 1, solution: 1, role: 'decoy' },
        { col: 2, row: 11, orientation: 0, solution: 0, role: 'decoy' },
        { col: 0, row: 9, orientation: 0, solution: 0, role: 'decoy' }
      ]
    },

    {
      ...
      objective: 'Twenty true lenses. Follow the labyrinth route through long folded light corridors.',
      grid: 14,
      source: { col: 0, row: 1, dir: 'right' },
      target: { col: 10, row: 7 },
      mirrors: [
        ...
        { col: 11, row: 9, orientation: 1, solution: 0, role: 'true' },
        { col: 6, row: 9, orientation: 1, solution: 0, role: 'true' },
        { col: 6, row: 12, orientation: 0, solution: 1, role: 'true' },
        { col: 8, row: 12, orientation: 1, solution: 0, role: 'true' },
        { col: 8, row: 7, orientation: 1, solution: 0, role: 'true' },
        { col: 2, row: 13, orientation: 0, solution: 1, role: 'decoy' },
        { col: 12, row: 3, orientation: 1, solution: 1, role: 'decoy' },
        { col: 1, row: 0, orientation: 1, solution: 1, role: 'decoy' },
        { col: 0, row: 13, orientation: 0, solution: 1, role: 'decoy' },
        { col: 4, row: 11, orientation: 1, solution: 1, role: 'decoy' },
        { col: 8, row: 5, orientation: 1, solution: 0, role: 'decoy' },
        { col: 5, row: 12, orientation: 1, solution: 0, role: 'decoy' },
        { col: 1, row: 9, orientation: 0, solution: 1, role: 'decoy' },
        { col: 12, row: 7, orientation: 0, solution: 1, role: 'decoy' },
        { col: 5, row: 8, orientation: 1, solution: 1, role: 'decoy' },
        { col: 7, row: 6, orientation: 1, solution: 0, role: 'decoy' },
        { col: 9, row: 0, orientation: 1, solution: 1, role: 'decoy' },
        { col: 1, row: 7, orientation: 0, solution: 1, role: 'decoy' },
        { col: 2, row: 12, orientation: 1, solution: 1, role: 'decoy' }
      ]
    },
    {
      id: 27,
    ...
    },
    {
      id: 29,
      title: 'Velvet Maze',
      objective: 'Twenty-three true lenses. A long maze of turns with dense false glass around the route.',
      grid: 15,
      source: { col: 14, row: 2, dir: 'left' },
      target: { col: 1, row: 10 },
      mirrors: [
        { col: 9, row: 2, orientation: 1, solution: 0, role: 'true' },
        { col: 9, row: 6, orientation: 1, solution: 0, role: 'true' },
        { col: 2, row: 6, orientation: 1, solution: 0, role: 'true' },
        { col: 2, row: 13, orientation: 0, solution: 1, role: 'true' },
        { col: 11, row: 13, orientation: 1, solution: 0, role: 'true' },
        { col: 11, row: 8, orientation: 1, solution: 0, role: 'true' },
        { col: 14, row: 8, orientation: 0, solution: 1, role: 'true' },
        { col: 14, row: 14, orientation: 1, solution: 0, role: 'true' },
        { col: 10, row: 14, orientation: 0, solution: 1, role: 'true' },
        { col: 10, row: 9, orientation: 0, solution: 1, role: 'true' },
        { col: 4, row: 9, orientation: 0, solution: 1, role: 'true' },
        { col: 4, row: 4, orientation: 0, solution: 1, role: 'true' },
        { col: 1, row: 4, orientation: 0, solution: 1, role: 'true' },
        { col: 1, row: 1, orientation: 1, solution: 0, role: 'true' },
        { col: 6, row: 1, orientation: 0, solution: 1, role: 'true' },
        { col: 6, row: 8, orientation: 0, solution: 1, role: 'true' },
        { col: 10, row: 8, orientation: 1, solution: 0, role: 'true' },
        { col: 10, row: 5, orientation: 0, solution: 1, role: 'true' },
        { col: 2, row: 5, orientation: 0, solution: 1, role: 'true' },
        { col: 2, row: 0, orientation: 1, solution: 0, role: 'true' },
        { col: 5, row: 0, orientation: 0, solution: 1, role: 'true' },
        { col: 5, row: 7, orientation: 1, solution: 0, role: 'true' },
        { col: 1, row: 7, orientation: 1, solution: 0, role: 'true' },
        { col: 9, row: 1, orientation: 0, solution: 1, role: 'decoy' },
        { col: 13, row: 9, orientation: 1, solution: 1, role: 'decoy' },
        { col: 11, row: 0, orientation: 1, solution: 1, role: 'decoy' },
        { col: 8, row: 10, orientation: 0, solution: 0, role: 'decoy' },
        { col: 9, row: 14, orientation: 0, solution: 1, role: 'decoy' },
        { col: 14, row: 1, orientation: 1, solution: 0, role: 'decoy' },
        { col: 0, row: 5, orientation: 1, solution: 1, role: 'decoy' },
        { col: 1, row: 12, orientation: 1, solution: 0, role: 'decoy' },
        { col: 8, row: 0, orientation: 1, solution: 1, role: 'decoy' },
        { col: 3, row: 8, orientation: 0, solution: 1, role: 'decoy' },
        { col: 14, row: 7, orientation: 0, solution: 1, role: 'decoy' },
        { col: 0, row: 8, orientation: 1, solution: 1, role: 'decoy' },
        { col: 6, row: 10, orientation: 0, solution: 1, role: 'decoy' },
        { col: 5, row: 8, orientation: 0, solution: 0, role: 'decoy' },
        { col: 12, row: 12, orientation: 1, solution: 0, role: 'decoy' },
        { col: 6, row: 0, orientation: 0, solution: 1, role: 'decoy' },
        { col: 5, row: 10, orientation: 1, solution: 1, role: 'decoy' }
      ]
    },
    {
      id: 30,
      title: 'Solar Labyrinth',
      objective: 'Twenty-four true lenses. The largest beam route yet: full-board travel before the bulb lights.',
      grid: 16,
      ...
      mirrors: [
        ...
        { col: 6, row: 2, orientation: 1, solution: 0, role: 'true' },
        { col: 9, row: 2, orientation: 0, solution: 1, role: 'true' },
        { col: 9, row: 4, orientation: 0, solution: 1, role: 'true' },
        { col: 15, row: 4, orientation: 1, solution: 0, role: 'true' },
        { col: 15, row: 1, orientation: 0, solution: 1, role: 'true' },
        { col: 13, row: 1, orientation: 1, solution: 0, role: 'true' },
        { col: 13, row: 9, orientation: 0, solution: 1, role: 'true' },
        { col: 15, row: 9, orientation: 1, solution: 0, role: 'true' },
        { col: 15, row: 5, orientation: 0, solution: 1, role: 'true' },
        { col: 12, row: 5, orientation: 1, solution: 0, role: 'true' },
        { col: 12, row: 13, orientation: 1, solution: 0, role: 'true' },
        { col: 5, row: 13, orientation: 1, solution: 0, role: 'true' },
        { col: 5, row: 15, orientation: 1, solution: 0, role: 'true' },
        { col: 0, row: 15, orientation: 0, solution: 1, role: 'true' },
        { col: 0, row: 10, orientation: 1, solution: 0, role: 'true' },
        { col: 5, row: 10, orientation: 0, solution: 1, role: 'true' },
        { col: 5, row: 12, orientation: 0, solution: 1, role: 'true' },
        { col: 10, row: 12, orientation: 0, solution: 1, role: 'true' },
        { col: 12, row: 15, orientation: 1, solution: 1, role: 'decoy' },
        { col: 10, row: 5, orientation: 1, solution: 1, role: 'decoy' },
        { col: 8, row: 10, orientation: 0, solution: 1, role: 'decoy' },
        { col: 14, row: 3, orientation: 0, solution: 1, role: 'decoy' },
        { col: 8, row: 7, orientation: 1, solution: 1, role: 'decoy' },
        { col: 12, row: 14, orientation: 0, solution: 0, role: 'decoy' },
        { col: 11, row: 3, orientation: 1, solution: 1, role: 'decoy' },
        { col: 10, row: 8, orientation: 0, solution: 0, role: 'decoy' },
        { col: 10, row: 1, orientation: 1, solution: 0, role: 'decoy' },
        { col: 3, row: 11, orientation: 1, solution: 0, role: 'decoy' },
        { col: 1, row: 13, orientation: 1, solution: 0, role: 'decoy' },
        { col: 14, row: 8, orientation: 0, solution: 0, role: 'decoy' },
        { col: 4, row: 13, orientation: 0, solution: 1, role: 'decoy' },
        { col: 2, row: 7, orientation: 1, solution: 0, role: 'decoy' },
        { col: 7, row: 11, orientation: 0, solution: 1, role: 'decoy' },
        { col: 10, row: 9, orientation: 1, solution: 0, role: 'decoy' },
        { col: 13, row: 12, orientation: 1, solution: 0, role: 'decoy' },
        { col: 4, row: 7, orientation: 0, solution: 1, role: 'decoy' }
      ]
    }
  ];
